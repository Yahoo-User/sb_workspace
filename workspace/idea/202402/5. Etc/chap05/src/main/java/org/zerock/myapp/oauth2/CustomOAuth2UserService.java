...
public class CustomOAuth2UserService implements OAuth2UserService< OAuth2UserRequest, OAuth2User > {
     ...
     * =======================================================
     * public OAuth2User
     *      CustomOAuth2UserService.loadUser(OAuth2UserRequest userRequest)
     ...
     *
     * Specified by:
     *      loadUser in interface `OAuth2UserService`
     * Params:
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
         ...
         * =======================================================
         * public OAuth2User
         *      DefaultOAuth2UserService.loadUser(OAuth2UserRequest userRequest)
         *      throws OAuth2AuthenticationException
         * =======================================================
...
//        ---
    ...
    private User saveOrUpdate(OAuthAttributes attributes) {
         ...
         *      `OptimisticLockingFailureException` – when the entity uses optimistic locking
         *                                            and has a version attribute with a different value from
         *                                            that found in the persistence store.
         *
         *                                            Also thrown if the entity is assumed to be present
