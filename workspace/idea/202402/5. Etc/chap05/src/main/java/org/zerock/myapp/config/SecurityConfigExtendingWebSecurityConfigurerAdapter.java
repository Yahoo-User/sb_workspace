 ...
 * Will automatically apply the result of looking up `AbstractHttpConfigurer` from `SpringFactoriesLoader`
 * to allow developers to extend the defaults.
 *
...
public class SecurityConfigExtendingWebSecurityConfigurerAdapter
        extends WebSecurityConfigurerAdapter {  // `WebSecurityConfigurerAdapter` Deprecated. (*****)
