...
@SpringBootTest(
	classes= {			// The declared classes created as bean object and registered into Spring Context when testing.
	...
	properties = {		// The declared properties will update legacy properties or append new properties ONLY in memory.
								// This declared properties CANNOT change `application.properties`  file.
...
public class UsingExternalCommonPropertiesTests {
	...
	@Resource 	private BoardVOWithRecordType vo;
...
//	@Disabled
	...
	@Test
//	@RepeatedTest(2)
	@DisplayName("1. testGetWebApplicationAndSystemPropertiesWithEnvironmentBean")
	@Timeout(1L)
	void testGetWebApplicationAndSystemPropertiesWithEnvironmentBean() {
		log.trace("testGetWebApplicationAndSystemPropertiesWithEnvironmentBean() invoked.");
	...
	} // testGetWebApplicationAndSystemPropertiesWithEnvironmentBean
