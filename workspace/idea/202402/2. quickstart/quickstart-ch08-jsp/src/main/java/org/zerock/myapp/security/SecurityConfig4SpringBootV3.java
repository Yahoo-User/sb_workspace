...
//@EnableWebSecurity
public class SecurityConfig4SpringBootV3

    // ***************************************************************************
    // In the Spring Boot v3.x
    // ***************************************************************************

    /*
     * ===========================================================
     * 1. `WebSecurityCustomizer` interface
     * ===========================================================
...
//    public void customize(WebSecurity web) { ;; } // customize
    ...
    /*
     * ===========================================================
     * 2. org.springframework.security.web.SecurityFilterChain` Bean
     * ===========================================================
...

{
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
        log.trace("securityFilterChain({}, {}) invoked.", http, introspector);
...
//        ---
        ...
        // ***************************************************************************
        // Step.2 The configuration requires authentication to the specified URLs
        //        and will grant access to URLs starting to only the specified user who has the specified roles.
        // ***************************************************************************
         ...
         *
         *  ------------------------
         *  4. Deprecated. For removal in 7.0.
         *  ------------------------
        ...
        http.authorizeHttpRequests(
            customizer ->
                customizer.
                    ...
                    requestMatchers(mvcMatcherBuilder.pattern("/system/**")).permitAll().
                    requestMatchers(mvcMatcherBuilder.pattern("/board/**")).authenticated().
...
/*
        http.authorizeHttpRequests(
            customizer -> {
                customizer.requestMatchers(new AntPathRequestMatcher("/"), new AntPathRequestMatcher("/system/**")).permitAll();
                customizer.requestMatchers(new AntPathRequestMatcher("/board/**")).authenticated();
                customizer.requestMatchers(new AntPathRequestMatcher("/system/**")).hasRole("ADMIN");
...
*/
        ...
        http.authorizeHttpRequests(
            (customizer) ->
                customizer.
                    requestMatchers(antMatcher("/"), antMatcher("/system/**")).permitAll().
                    requestMatchers(antMatcher("/board/**")).authenticated().
                    requestMatchers(antMatcher("/system/**")).hasRole("ADMIN").
                    anyRequest().permitAll()
        ); // .authorizeHttpRequests
        ...
        http.formLogin(
            customizer ->
                customizer.
                     ...
                     *  e. If "/authenticate" was passed to this method, it update the defaults as shown below:
...
//        ---
        ...
        // ***************************************************************************
        // Step.6 Configuring Log out (Sign-Out) Processing.
        // ***************************************************************************
        ...
        // ------------------------
        // 1st. method - XX (* Deprecated *) in Spring Boot v3.x
        // ------------------------
/*
        http.
            logout().
...
//        ); // .logout
        ...
        rememberMe(   // Enable `Remember-Me` feature using `JSESSIONID` and 'remember-me' cookies.
            customizer ->
                customizer.
