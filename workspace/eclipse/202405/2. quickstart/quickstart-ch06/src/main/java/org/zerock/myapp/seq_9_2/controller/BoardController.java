package org.zerock.myapp.seq_9_2.controller;
...
public class BoardController extends CommonBeanCallbacks {
	...
	String registerProcess(@RequestParam("title") String title2, String writer, String content, Integer currPage, RedirectAttributes rttrs) {
		log.trace("registerProcess({}, {}, {}, {}) invoked.", title2, writer, content, currPage);
