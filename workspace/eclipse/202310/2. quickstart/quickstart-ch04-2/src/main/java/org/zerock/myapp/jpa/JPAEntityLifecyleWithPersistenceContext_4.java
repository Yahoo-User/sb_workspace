...
public class JPAEntityLifecyleWithPersistenceContext_4 {
	...
	public static void main(String[] args) {
		...
		// ----------------
		Person transientPerson = new Person();							// The state in the lifecycle of an entity : Transient
		...
		em.persist(transientPerson);			// The state in the lifecycle of an entity : Transient -> Managed
		...
		// ----------------
		// Step3. Find an Entity By Primary Key From the Underlying Database:
		//				(1) Persisted
		//				(2) Detached
		//				(3) Merged
		// ----------------
...
//		em.flush();
		...
		//				(2) Detached
		//				(3) Merged
		mergedPerson = em.find(Person.class, mergedPerson.getId());
		...
		Person removedPerson = mergedPerson;
		...
		// ----------------
		// StepN. Clear all Entities from the Persistence Context.
		// ----------------
		em.clear();
	} // main
